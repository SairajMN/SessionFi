/**
 * SessionFi Off-Chain Session Engine
 *
 ...
 *
 * Trust model:
 * - Engine cannot forge user signatures
 * - Engine cannot violate capital constraints
 * - All state transitions are verifiable
 * - User always has last valid signed state for recovery
 */
...
/**
 * SessionEngine manages the lifecycle and state transitions of sessions.
 *
 * Architecture:
